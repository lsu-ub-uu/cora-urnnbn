...
public class AnnotationTestHelper {
	...
	public void assertDefaultVauleParamAnnotationByNameAndPosition(Object value,
			int startPosition) {
		DefaultValue parameterDefault = (DefaultValue) parameterAnnotations[startPosition][1];

		assertEquals(parameterDefault.value(), value);
	}
